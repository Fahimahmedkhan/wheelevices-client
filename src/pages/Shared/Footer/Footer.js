        ...
        <div>
            <footer className="footer p-10 bg-gray-600 text-white">
                ...
                <div>
                    ...
                    <span className='font-semibold text-sm'>+8801788844667</span>
                </div>
            </footer>
            <footer className="footer p-10 bg-gray-600 text-white">
                <div>
                    ...
                    <Link className='hover:text-orange-600' to='/order'>Order</Link>
                    <Link className='hover:text-orange-600' to='/products'>Products</Link>
                </div>
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-gray-600 text-white border-base-300">
                <div className="items-center grid-flow-col">
                    <div className='fill-current w-28'>
                        <Link to='/'><img src={logo} alt="" /></Link>
                    </div>
                    <p><span className='font-bold text-xl'>Wheelevices</span> <br />Providing reliable tech since 2022</p>
                </div>
            ...
            <footer className='px-10 py-4 border-t bg-gray-600 text-white border-base-300 text-center'>
                <p>Copyright © 2022 - All right reserved by <span className='font-bold text-xl'>Wheelevices</span></p>
            </footer>
        </div>
    );
};
